...
export default function App() {
  ...
  return <div className="min-h-screen">
    ...
    <main className="mobile-main lg:ml-64 lg:pb-10"><div className="mx-auto max-w-6xl px-4 py-7 md:px-8 md:py-10"><button type="button" onClick={()=>setActive('sync')} className="mb-5 inline-flex min-h-10 items-center gap-2 rounded-2xl border bg-white px-4 py-2 text-sm font-bold shadow-sm transition hover:-translate-y-0.5 dark:bg-zinc-900"><Icons.Cloud size={17}/>Открыть синхронизацию</button>{content}</div></main>
